...
import { updateChannelDescription } from "../../../interfaces/Channel.Controller.Interface";
import { filterXSS } from "xss";
import { logger } from "../../../logger/pino.js";

export class UpdateChannelDescriptionService {
    ...
    public update: updateChannelDescription = async (request: FastifyRequest<{
        ...
        try {
            ...
            const newDesciption: string = request.body.newDesciption;
            ...
            if (!membership || membership.role !== 'admin') {
                ...
                return reply.status(StatusCodes.FORBIDDEN).send({
                    ...
                    error: "Only an admin can change the channel's desciption",
            ...
            const updatedDecription: { description: string | null } = await this.prisma.channel
                .update({
                    ...
                    data: {
                        ...
                        description: filterXSS(newDesciption)
            ...
            return reply.status(StatusCodes.OK).send({
                ...
                channel: {
                    ...
                    name: updatedDecription.description
